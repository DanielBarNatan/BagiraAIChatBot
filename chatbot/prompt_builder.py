...
def build_prompt(
    ...
    instruction = (
        ...
        "Reply in the same language the user writes in (Hebrew for Hebrew, English for English). "
        "Keep technical terms and work item titles in their original language.\n"
        ...
        "provide a best-effort answer based on what you found and note that it may not be fully accurate.\n"
